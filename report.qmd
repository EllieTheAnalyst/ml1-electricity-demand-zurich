...
At threshold 0.3, the model catches 82% of real peak hours at a precision of 54%. It raises more false alarms than a stricter threshold would, but in a grid context that is the right tradeoff: better to over-prepare than to leave anyone without power.
